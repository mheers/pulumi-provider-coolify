...
require (
	github.com/coolify-terraform/terraform-provider-coolify/shim v0.0.0
...
require (
	...
	github.com/coolify-terraform/terraform-provider-coolify v0.1.17-0.20260818201154-7dd47f704fb8 // indirect
