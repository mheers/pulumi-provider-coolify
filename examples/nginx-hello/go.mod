module github.com/mheers/pulumi-provider-coolify/examples/nginx-hello

go 1.26.5

require (
	github.com/mheers/pulumi-provider-coolify/sdk v0.0.0
...
replace github.com/mheers/pulumi-provider-coolify/sdk => ../../sdk
